          ...
          <article className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm" key={report.id}>
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              ...
              <div className="flex gap-2">
                <button className="rounded-md bg-emerald-900 px-3 py-2 text-sm font-bold text-white" onClick={() => updateReport(report.id, "resolved")}>
                  Resolve
                </button>
                <button className="rounded-md border border-stone-300 px-3 py-2 text-sm font-bold" onClick={() => updateReport(report.id, "dismissed")}>
                  Dismiss
                </button>
              </div>
            </div>
